...
from models.model2 import IterativeTextGuidedPoseGenerationModel
...
def main():
    ...
    model = IterativeTextGuidedPoseGenerationModel(
        ...
        lr_length_predictor=1e-3,  # Added learning rate for length predictor
    ...
    last_checkpoint_path = os.path.join(CHECKPOINT_DIR_LAST, 'last-2.ckpt')
    if os.path.exists(last_checkpoint_path):
        latest_checkpoint = last_checkpoint_path
        print(f"Resuming training from checkpoint: {latest_checkpoint-2}")
